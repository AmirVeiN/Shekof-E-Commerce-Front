      ...
      <div class="flex peer flex-col w-[264px] justify-center items-center space-y-2  rounded-md">
        ...
        <div class="flex flex-col justify-center px-4 items-center gap-2">
          ...
          <div class="productRating">
            <star-rating v-bind:show-rating="false" v-bind:read-only="true" v-bind:increment="1" v-bind:rating="likes"
              v-bind:max-rating="5" v-bind:border-width="1" inactive-color="#fff" border-color="#999"
              v-bind:star-size="15">
            </star-rating>
          </div>
          ...
          <div class="productPrice text-sm font-bold space-x-1 text-[#435fcb] text-right ss02 flex flex-row">
            <div class="">تومان</div>
