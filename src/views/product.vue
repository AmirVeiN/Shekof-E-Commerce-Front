<template>
      ...
      <div
        ...
        <div class="flex flex-col space-y-2">
          ...
          <div class="productColor flex flex-row space-x-2">
            <div class="w-[24px] h-[24px] bg-[#37363b] rounded-full shadow-md" v-if="colorList().includes('Black')"></div>
            <div class="w-[24px] h-[24px] bg-[#a4a28c] rounded-full shadow-md" v-if="colorList().includes('Olive')"></div>
            <div class="w-[24px] h-[24px] bg-[#b3abbd] rounded-full shadow-md" v-if="colorList().includes('Purple')">
            </div>
            <div class="w-[24px] h-[24px] bg-[#f2f2f2] rounded-full shadow-md" v-if="colorList().includes('White')"></div>
            <div class="w-[24px] h-[24px] bg-[#f7f1e8] rounded-full shadow-md" v-if="colorList().includes('Cream')"></div>
            ...
            <div class="w-[24px] h-[24px] bg-[#428aae] rounded-full shadow-md" v-if="colorList().includes('Blue')"></div>
            <div class="w-[24px] h-[24px] bg-[#60765f] rounded-full shadow-md" v-if="colorList().includes('Green')"></div>
        ...
        <div class="flex flex-row justify-center space-x-5 items-center pt-4">
          <button class="px-6 py-3 bg-[#435fcb] font-semibold rounded-lg text-white">
            افزودن به سبد خرید
          </button>
        ...
        <div class="w-full py-4 px-5 bg-[#ECEFF9] rounded-2xl flex flex-row-reverse">
          <div>10</div>
        ...
        <div class="flex flex-row space-x-3 justify-center items-center font-bold text-sm">
          <div class="flex flex-row space-x-1 gap-3">
            <font-awesome-icon class="text-base text-[#333]/70 cursor-pointer hover:text-[#333]"
  ...
  <div class="flex justify-center items-center h-full">
    <div class="flex flex-row-reverse w-[70%] gap-8 items-center pt-7 font-bold text-[#c7c7c7]">
      <button class="text-lg transition duration-300 ease-in-out cursor-pointer hover:text-[#333]">
        توضیحات
      </button>
      <button class="text-lg transition duration-300 ease-in-out cursor-pointer hover:text-[#333]">
        مشخصات کلی
