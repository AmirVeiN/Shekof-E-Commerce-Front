<template>
  ...
  <div class="w-full h-full flex justify-center items-center">
    <div dir="rtl" class="p-3 ss02 w-[70%] min-w-[1000px]">
      <div class="flex justify-center items-center">
        <P class="text-center text-gray text-sm">
          <br />
          ای نور ما ای سور ما ای دولت منصور ما <br />جوشی بنه در شور ما تا می شود
          انگور ما <br />
          ای دلبر و مقصود ما ای قبله و معبود ما <br />آتش زدی در عود ما نظاره کن
          در دود ما <br />ای یار ما عیار ما دام دل خمار ما <br />
      ...
      <div class="text-right mb-5">
        ...
        <p class="text-gray text-sm">
          ...
          صورت عدم پاسخگویی تماس تلفنی، می‌توانید از طریق ایمیل یا فرم ارتباطی زیر
          درخواست خود را ارسال کرده تا در اسرع وقت با شما تماس گرفته شود.
        </p>
      </div>
      <p class="text-right text-2xl font-medium text-ultrablue mb-5">
        آدرس های شکاف​
      </p>
      <div class="text-right flex mb-5">
        <div class="w-[50%]">
          ...
          <div>
            <NeshanMap ref="mapRef" :mapKey="mapKey" :serviceKey="serviceKey"
              :center="{ latitude: 35.69672648316882, longitude: 51.36281969540723 }" :zoom="12" :scale="0.8" />
          </div>
        </div>
        <div class="w-[50%]">
      ...
      <div class="flex flex-col">
        ...
        <p class="text-gray text-sm mb-5">
          در صورت خرید محصولات سایت <a href="#" class="text-ultrablue">شکاف</a> ،
          جهت تسریع در پاسخ‌گویی لطفاً شماره سفارش (پیگیری) را در ایمیل خود ذکر
          کنید.
        </p>
        <p class="text-gray text-sm mb-5">ایمیل مدیریت: info@shekaf.org</p>
        <p class="text-gray text-sm mb-5">ایمیل پشتیبانی: support@shekaf.org</p>
      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-2">
          ...
          <div class="flex flex-col px-4 mb-5">
            <label class="text-sm text-ultrablack mb-2" for="">بخش مربوطه </label>
            <select id=""
...
" placeholder=" در صورت داشتن شماره پیگیری آن را وارد کنید" />
        ...
        <div class="flex flex-col px-4 mb-5">
          ...
          <button type="submit" class="text-center cursor-pointer text-sm bg-submitgray w-20 px-5 py-2 ">ارسال</button>
        </div>
      </div>
    </div>
  </div>
...
const mapKey = "web.593931940c0e4d448cd74fd171201a11"
const serviceKey = "service.06992fe3024746b5a96671386714b76e"
